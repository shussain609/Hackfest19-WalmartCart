...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Verification");
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            mDetailText.setText(getString(R.string.firebase_status_fmt, user.getUid())+" SRIJAN");
            Intent i = new Intent(this,AddCartActivity.class);
            i.putExtra("FIREBASE_UID", user.getUid());
            startActivity(i);
            finish();
        }
    }
